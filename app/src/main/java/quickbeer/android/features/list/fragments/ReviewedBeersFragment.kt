...
class ReviewedBeersFragment : BeerListFragment() {
    ...
    private val dataBinder = object : SimpleDataBinder() {
        override fun bind(subscription: CompositeSubscription) {
            super@ReviewedBeersFragment.dataBinder().bind(subscription)
        ...
        override fun unbind() {
            super@ReviewedBeersFragment.dataBinder().unbind()
        }
    }
    ...
    override fun toStatusValue(progressStatus: ProgressStatus): String {
        return if (progressStatus === ProgressStatus.EMPTY)
