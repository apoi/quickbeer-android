...
public class Countries implements SimpleListSource<Country> {
    ...
    private void initCountries() {
        ...
        countries.put(29, new Country(29, "Bosnia and Herzegovina", "BA"));
        ...
        countries.put(57, new Country(57, "Democratic Republic of Congo", "CD"));
        ...
        countries.put(132, new Country(132, "Mayotte", "YT"));
        ...
        countries.put(137, new Country(137, "Montserrat", "MS"));
        ...
        countries.put(185, new Country(185, "Saint Helena", "SH"));
        countries.put(186, new Country(186, "Saint Kitts and Nevis", "KN"));
        ...
        countries.put(227, new Country(227, "Saint Vincent & the Grenadines", "VC"));
        ...
        countries.put(235, new Country(235, "Palestine/West Bank", "PS"));
        countries.put(236, new Country(236, "East Timor", "TL"));
        countries.put(237, new Country(237, "Tibet", "CN"));
        countries.put(238, new Country(238, "Northern Ireland", "GB"));
        countries.put(239, new Country(239, "Wales", "GB"));
        countries.put(240, new Country(240, "England", "GB"));
        countries.put(241, new Country(241, "Scotland", "GB"));
        ...
        countries.put(256, new Country(256, "Mauritania", "MR"));
        countries.put(257, new Country(257, "Curaçao", "CW"));
        countries.put(258, new Country(258, "Sint Maarten", "SX"));
        countries.put(259, new Country(259, "South Sudan", "SS"));
        countries.put(260, new Country(260, "Turkish Republic of Cyprus", "CY"));
        countries.put(261, new Country(261, "Transdniestra", "MD"));
        countries.put(262, new Country(262, "Somaliland", "SO"));
        countries.put(263, new Country(263, "Abkhazia", "GE"));
        countries.put(264, new Country(264, "Nagorno-Karabakh", "AZ"));
        countries.put(265, new Country(265, "South Ossetia", "GE"));
        countries.put(266, new Country(266, "Western Sahara", "EH"));
        countries.put(267, new Country(267, "Bonaire", "BQ"));
    }
}
