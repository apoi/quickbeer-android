...
public class Styles implements SimpleListSource<Style> {
    ...
    private void initStyles() {
        ...
        styles.put(14, new Style(14, "Lambic Style - Fruit"));
        ...
        styles.put(28, new Style(28, "Dunkel/Tmavý"));
        styles.put(29, new Style(29, "Schwarzbier"));
        styles.put(31, new Style(31, "Czech Pilsner (Světlý)"));
        styles.put(35, new Style(35, "Cream Ale"));
        styles.put(36, new Style(36, "Amber Lager/Vienna"));
        ...
        styles.put(48, new Style(48, "Witbier"));
        styles.put(52, new Style(52, "Sour/Wild Ale"));
        ...
        styles.put(65, new Style(65, "Imperial Pils/Strong Pale Lager"));
        styles.put(71, new Style(71, "Abbey Dubbel"));
        styles.put(72, new Style(72, "Abbey Tripel"));
        styles.put(73, new Style(73, "Lambic Style - Gueuze"));
        ...
        styles.put(77, new Style(77, "Lambic Style - Faro"));
        styles.put(78, new Style(78, "Lambic Style - Unblended"));
        styles.put(79, new Style(79, "Foreign Stout"));
        styles.put(80, new Style(80, "Abt/Quadrupel"));
        styles.put(81, new Style(81, "Imperial IPA"));
        ...
        styles.put(112, new Style(112, "Ice Cider/Ice Perry"));
        styles.put(113, new Style(113, "Imperial Porter"));
        styles.put(114, new Style(114, "Black IPA"));
        styles.put(115, new Style(115, "Polotmavý"));
        styles.put(116, new Style(116, "Sahti/Gotlandsdricke/Koduõlu"));
        styles.put(117, new Style(117, "Grodziskie/Gose/Lichtenhainer"));
        styles.put(118, new Style(118, "Sour Red/Brown"));
        styles.put(121, new Style(121, "Session IPA"));
        styles.put(122, new Style(122, "Radler/Shandy"));
    }
}
