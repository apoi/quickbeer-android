...
import quickbeer.android.feature.barcode.camera.CameraSourcePreview
...
class LiveBarcodeScanningActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun startCameraPreview() {
        val workflowModel = workflowModel ?: return
    ...
    private fun setUpWorkflowModel() {
        ...
        workflowModel!!.workflowState.observe(this, Observer { workflowState ->
            if (workflowState == null || com.google.common.base.Objects.equal(currentWorkflowState, workflowState)) {
                return@Observer
            }
