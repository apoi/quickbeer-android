...
data class BrewerMetadata(
    ...
    companion object {
        fun newUpdate(brewerId: Int): BrewerMetadata {
            return BrewerMetadata(brewerId = brewerId, updated = ZonedDateTime.now())
        }

        fun newAccess(brewerId: Int): BrewerMetadata {
            return BrewerMetadata(brewerId = brewerId, accessed = ZonedDateTime.now())
        }

        fun merge(v1: BrewerMetadata, v2: BrewerMetadata): BrewerMetadata {
