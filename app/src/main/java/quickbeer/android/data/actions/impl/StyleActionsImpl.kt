...
constructor(context: Context,
    ...
    private fun triggerGetBeers(styleId: Int, needsReload: (ItemList<String>) -> Boolean): Observable<DataStreamNotification<ItemList<String>>> {
